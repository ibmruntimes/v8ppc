...
void NamedLoadHandlerCompiler::GenerateLoadViaGetter(
  ...
  // -----------------------------------
  {
    ...
    if (accessor_index >= 0) {
      ...
      __ LoadP(scratch, FieldMemOperand(holder, HeapObject::kMapOffset));
      __ LoadInstanceDescriptors(scratch, scratch);
      __ LoadP(scratch, FieldMemOperand(scratch,
            DescriptorArray::GetValueOffset(accessor_index)));
      __ LoadP(r4, FieldMemOperand(scratch, AccessorPair::kGetterOffset));
