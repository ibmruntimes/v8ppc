...
#define MASK_BITSET_TYPE_LIST(V) \
  V(Representation, 0x7ff80000u) \
  V(Semantic,       0x0007ffffu)
...
#define REPRESENTATION_BITSET_TYPE_LIST(V)    \
  V(None,               0)                    \
  V(UntaggedBit,        1u << 19 | kSemantic) \
  V(UntaggedSigned8,    1u << 20 | kSemantic) \
  V(UntaggedSigned16,   1u << 21 | kSemantic) \
  V(UntaggedSigned32,   1u << 22 | kSemantic) \
  V(UntaggedUnsigned8,  1u << 23 | kSemantic) \
  V(UntaggedUnsigned16, 1u << 24 | kSemantic) \
  V(UntaggedUnsigned32, 1u << 25 | kSemantic) \
...
#define INTERNAL_BITSET_TYPE_LIST(V)                                      \
  V(OtherUnsigned31, 1u << 0 | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(OtherUnsigned32, 1u << 1 | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(OtherSigned32,   1u << 2 | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(OtherNumber,     1u << 3 | REPRESENTATION(kTagged | kUntaggedNumber))
#else  // V8_PPC_TAGGING_OPT
#define INTERNAL_BITSET_TYPE_LIST(V)                                      \
...
#define SEMANTIC_BITSET_TYPE_LIST(V) \
  V(NegativeSignedSmall, 1u << 4  | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(Null,                1u << 5  | REPRESENTATION(kTaggedPointer)) \
  V(Undefined,           1u << 6  | REPRESENTATION(kTaggedPointer)) \
  V(Boolean,             1u << 7  | REPRESENTATION(kTaggedPointer)) \
  V(UnsignedSmall,       1u << 8  | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(MinusZero,           1u << 9  | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(NaN,                 1u << 10 | REPRESENTATION(kTagged | kUntaggedNumber)) \
  V(Symbol,              1u << 11 | REPRESENTATION(kTaggedPointer)) \
  ...
  V(Array,               1u << 15 | REPRESENTATION(kTaggedPointer)) \
